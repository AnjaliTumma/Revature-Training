 ...
 * Generated at: 2024-08-30 16:13:43 UTC
...
public final class newpasssword_jsp extends org.apache.jasper.runtime.HttpJspBase
...
if (newPassword == null || confirmPassword == null || newPassword.isEmpty() || confirmPassword.isEmpty()) {
    ...
    try {
        ...
        rs = st.executeQuery("SELECT * FROM users WHERE email='" + email + "' AND password='" + oldPassword + "'");
        if (rs.next()) { // Corrected to if block
            check = 1;
