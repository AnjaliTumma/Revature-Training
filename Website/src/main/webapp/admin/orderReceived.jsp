		...
		<table style="border:2px solid black">
			...
			%>
				<tr>
					...
					<td><a href="cancelOderAction.jsp?id=<%=rs.getString(2)%>&email=<%=rs.getString(1)%>">Cancel</a></td>
					<td><a href="deliveryOrderAction.jsp?id=<%=rs.getString(2)%>&email=<%=rs.getString(1)%>">Delivered</a></td>
				</tr>
				<%}} 
				catch(Exception e){
